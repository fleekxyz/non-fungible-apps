...
contract SitesNFTs is ISitesNFTs, ERC721URIStorage, AccessControl  {
    ...
    function mint(string memory base64EncodedMetadata, address account) public canMint override returns (uint256) {
    ...
    function updateTokenURI(address tokenHolderAddress, uint256 tokenId, string memory base64EncodedMetadata) public canMint override {
    ...
    function setBaseURI(string memory _newBbaseURI) public canChangeBaseURI override returns (string memory) {
