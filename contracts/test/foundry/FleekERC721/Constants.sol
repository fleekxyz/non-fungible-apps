...
library TestConstants {
    ...
    IERCX.Categories public constant CATEGORY = IERCX.Categories.DeFi;

    function getBuild() internal pure returns (IERCX.Build memory) {
        return IERCX.Build("abcdefg", "repository", "qwerty", "https://fleek.xyz");
    }
